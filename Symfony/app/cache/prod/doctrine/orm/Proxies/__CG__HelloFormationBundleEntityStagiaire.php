 ...
 */
class Stagiaire extends \Hello\FormationBundle\Entity\Stagiaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'prenom', 'age', 'module');
        }
